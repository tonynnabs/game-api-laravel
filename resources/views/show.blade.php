            ...
            <div class="lg:ml-12 lg:mr-30 ">
                ...
                <div class="flex flex-wrap items-center mt-8 ">
                    ...
                    <div class="flex items-center space-x-4 mt-4 lg:mt-0 lg:ml-12">
                        @if (isset($game['socials']['instagram']))
                        ...
                        @endif
                        @if (isset($game['socials']['facebook']))
                            <div class="w-8 h-8 bg-gray-800 rounded-full flex justify-center items-center">
                ...
                <div class="mt-12">
                    ...
                    @if (isset($game['trailer']))
                        <a target="_blank" href="https://youtube.com/watch/{{ $game['trailer'] }}"
                                        ...
                                        <div class="modal-body px-8 py-8">
                                            <div class="responsive-container overflow-hidden relative"
                                                ...
                                                <iframe class="responsive-iframe absolute top-0 left-0 w-full h-full"
                                                    width="560" height="315" src="https://www.youtube.com/embed/Fp9pNPdNwjI"
